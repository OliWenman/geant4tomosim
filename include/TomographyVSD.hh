...
class TomographyVSD : public G4VSensitiveDetector
{
  	public:
		TomographyVSD(const G4String& name, const G4String& hitsCollectionName, G4int NumDetectorsY, G4int NumDetectorsZ, Data* data,  const G4bool DetEfficiency);
    		virtual ~TomographyVSD();
